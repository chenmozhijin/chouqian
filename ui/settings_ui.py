...
class Ui_settings(object):
    def setupUi(self, settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 642, 288))
        ...
        self.CardWidget.setProperty("borderRadius", 5)
        ...
        self.SwitchButton.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.CardWidget_2.setProperty("borderRadius", 5)
        ...
        self.SwitchButton_2.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
        ...
        self.SpinBox.setMinimumSize(QSize(200, 32))
        font = QFont()
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.CardWidget_5.setProperty("borderRadius", 5)
    ...
    def retranslateUi(self, settings):
        ...
        self.SwitchButton.setProperty("text", QCoreApplication.translate("settings", u"\u5173", None))
        self.SwitchButton.setProperty("onText", QCoreApplication.translate("settings", u"\u5f00", None))
        self.SwitchButton.setProperty("offText", QCoreApplication.translate("settings", u"\u5173", None))
        self.BodyLabel_2.setText(QCoreApplication.translate("settings", u"\u51cf\u5c11\u91cd\u590d", None))
        self.SwitchButton_2.setProperty("text", QCoreApplication.translate("settings", u"\u5173", None))
        self.SwitchButton_2.setProperty("onText", QCoreApplication.translate("settings", u"\u5f00", None))
        self.SwitchButton_2.setProperty("offText", QCoreApplication.translate("settings", u"\u5173", None))
